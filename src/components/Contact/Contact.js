        ...
        return (
            <div className="custom-page">
                ...
                <div className="custom-page__nav">
                    <a href="/">
                        <img alt="logo" className="custom-page__nav__logo" src={Logo} />
                    </a>
                    <ul className="custom-page__navlinks">
                        <li>
                            <a href="/" className="custom-page__navlinks">
                                Home
                            </a>
                        </li>
                ...
                <div className="custom-page__content">
                    <div className="custom-page__contactUs">
                        ...
                        <div className="custom-page-contactHead">
                            ...
                            {this.state.isSuccessShowed && <div className="contact-success">Thank you for contacting us we will get back to you soon.</div>}
                ...
                <div className="custom-page__footer-wrapper">
                    <div className="custom-page__footer">
                        ...
                        <div className="custom-page__footer-item">
                            <span className="custom-page__footer-item__title"> Social </span>
                            ...
                            <p>Follow us in social media to get exclusive resources straight to your feed</p>
                        </div>
                        {/* Footer Item */}
                        <div className="custom-page__footer-item">
                            <span className="custom-page__footer-item__title"> Content </span>
                        ...
                        {/* Footer Item */}
                        <div className="custom-page__footer-item">
                            <span className="custom-page__footer-item__title"> About </span>
                    ...
                    <div className="custom-page__footer-copyright">
                        <span>{this.state.websiteName}</span> Copyright © 2024, All rights reserved.
                    </div>
                </div>
            </div>
        );
