            ...
            <div className={this.props.openSidebarClicked ? "sidebar-wrapper sidebar-wrapper-open" : "sidebar-wrapper"}  >
                ...
                <div className="sidebar">
                    ...
                    <ul className="sidebar__navigationList">
                        ...
                        <li className="sidebar__navigationList-item">
                            <ImParagraphLeft style={{color:'white'}} />
                           
                            <Link to={{pathname:"/adm/phrases"}}  className="sidebar-navigatioList-itemLink" > Pre written phrases</Link>

                        </li>
                        <li className="sidebar__navigationList-item">
                        <MdOutlineReviews style={{color:'white'}} />
                            <Link to={{pathname:"/adm/reviews"}}  className="sidebar-navigatioList-itemLink" >  Reviews</Link>
