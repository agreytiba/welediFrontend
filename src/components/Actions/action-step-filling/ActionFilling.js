...
class ActionFilling extends Component {
            ...
            <div id="introd" className="action-introWrapper filling">
                ...
                <div className="formHead">
                    ...
                    <div className="actionFilling__headAction">
                        ...
                        <a onClick={() => this.props.goToResumeSelectionStep()} className="authenticationButton">
                            return
                        </a>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="grid-2-col">
                        ...
                        {this.props.currentResumeName === 'Cv1' || this.props.currentResumeName === 'Cv5' || this.props.currentResumeName === 'Cv6'|| this.props.currentResumeName === 'Cv14'|| this.props.currentResumeName === 'Cv15' ? (
  ...
  */}
                    ...
                    <SimpleTextArea   suggestions = {true}        categories={this.state.categories}      addSummary = {this.props.addSummary}name="Professional Summary" value={this.props.values.summary} handleInputs={this.props.handleInputs} title={t('form.profesionalSummary')} />
